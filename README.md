...
**Status: M6 complete; M6.5 awaits App Attest-capable device proof; M7.2a is implemented.**
The staging backend, conformance-only iOS target, independent App Attest receipt
...
provision the connected iPhone with an Apple Developer Program team, install the
staging Auth fixture, and run the documented smoke test before settlement
