...
def main():
    ...
    spec = importlib.util.spec_from_file_location('session_regression_support', Path(__file__).with_name('beta-concurrency.py'))
    support = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(support)
    support.DB = f'postgresql://postgres:postgres@127.0.0.1:{args.port}/postgres'
