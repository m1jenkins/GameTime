...
Working Directory for your metadata: `/Users/user/Documents/GitHub/GameTime/.agents/teamwork_preview_explorer_m4_investigator` (create directory/files if needed).
...
Once complete, write the file to `/Users/user/Documents/GitHub/GameTime/.agents/teamwork_preview_explorer_m4_3/handoff.md` and send a message back to me (Recipient: 078beb9b-77ea-480f-9f54-e47a68d2df5a).
