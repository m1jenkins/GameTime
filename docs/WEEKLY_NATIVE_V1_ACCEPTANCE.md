...
| Weekly native unit suite | 18 passed within the full gate: exact envelopes, account/session isolation, retirement, absent completeness, pause/safety, nonblocking optional study delivery, delayed draft previews and scheduled/late-read social-cache expiry |
