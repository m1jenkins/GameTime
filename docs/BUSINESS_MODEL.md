...
| Working Beta 1 scope | Creator plus up to five friends (2–6 total); four friend goals and four personal goals across the same four Apple Health metrics; one community steps goal; scheduled 1–30-day windows. D140 excludes the four target-free friend leaderboards from the Beta release requirement. D141 adds optional new local versions ranking eligible activity saved by the correction deadline; old agreements keep their rules. |
