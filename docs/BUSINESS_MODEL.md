...
| Working Beta 1 scope | Creator plus up to five friends (2–6 total); four friend goals and four personal goals across the same four Apple Health metrics; one community steps goal; scheduled 1–30-day windows. D140 defers the four target-free friend leaderboards beyond Beta distribution while preserving their product rules. |
