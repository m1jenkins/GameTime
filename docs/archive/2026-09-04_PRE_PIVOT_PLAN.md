# Historical Personal and sandbox beta plan

Archived on September 4, 2026 before replacing the active roadmap.
The original PLAN.md follows verbatim after the separator. Its milestone
status records earlier observations, not a fresh hosted or device audit.

The adopted future direction is friend duels and personal performance
commitments: see [BUSINESS_MODEL.md](../BUSINESS_MODEL.md),
[the current roadmap](../../PLAN.md), and D123 in
[DECISIONS.md](../../DECISIONS.md). The old Deferred V2 prohibition on pooled
stakes and participant payouts is superseded for new products only. Existing
Personal, Solo, and charity agreements keep their original terms. This archive
does not authorize execution, deployment, distribution, or live payments.
Paths in the preserved text were written relative to the repository root.
